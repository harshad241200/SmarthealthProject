<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" EnableEventValidation="false" Inherits="SmartHealthConsltation.edit" %>
              ...
              <form runat="server">
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8 col-lg-8">
                          <asp:TextBox ID="patientnames" CssClass="form-control" runat="server" Text='<%# Eval("patientname") %>'></asp:TextBox>
                      </div>
                  </div>
                  <!---->
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-lg-8">
                        <asp:TextBox ID="contac" CssClass="form-control" runat="server" Text='<%# Eval("contact") %>'></asp:TextBox>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-lg-8">
            <asp:TextBox ID="dates" runat="server" CssClass="form-control" type="date" Text='<%# Eval("DATE") %>'></asp:TextBox>
                    </div>
                </div>
                <!---->
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-lg-8">
                        <asp:TextBox ID="times" CssClass="form-control" runat="server" type="time" Text='<%# Eval("TIME") %>'></asp:TextBox>
                       </div>
                </div>
                <!---->
               <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-lg-8">
                        <asp:TextBox ID="Symptomss" CssClass="form-control" runat="server" Text='<%# Eval("Symptoms") %>'></asp:TextBox>
                    </div>
                </div>
              
                <div class="form-group row justify-content-end">
                    <div class="col-sm-5">
                        <asp:Button ID="Button1" runat="server" Text="Button" OnClick="EDIT" />
                    </div>
                </div>
